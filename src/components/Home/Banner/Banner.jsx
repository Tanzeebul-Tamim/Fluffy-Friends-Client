  ...
  return (
    <div className="carousel w-full">
      <div id="slide1" className="carousel-item relative w-full">
        ...
        />
        <div className="absolute flex text-pink-500 lg:justify-start  items-center gap-4 left-0 h-full top-0 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)]">
            <div className='text-white lg:space-y-10 pl-4 lg:pl-24 w-3/5 lg:w-3/5'>
                ...
                <button className="btn lg:flex hidden btn-primary text-white bg-pink-500 border-0">Discover More</button>
            </div>
        </div>
        <div className="absolute flex left-2 right-2 justify-end gap-1 lg:justify-between transform lg:-translate-y-1/2 translate-y-full lg:left-5 lg:right-5 top-1/2">
          <a href="#slide4" className="btn bg-pink-500 border-0 btn-circle">
            ❮
          </a>
          <a href="#slide2" className="btn bg-pink-500 border-0 btn-circle">
            ❯
          </a>
        </div>
      </div>
      <div id="slide2" className="carousel-item relative w-full">
        ...
        <div className="absolute flex left-2 right-2 justify-end gap-1 lg:justify-between transform lg:-translate-y-1/2 translate-y-full lg:left-5 lg:right-5 top-1/2">
          <a href="#slide1" className="btn bg-pink-500 border-0 btn-circle">
            ❮
          </a>
          <a href="#slide3" className="btn bg-pink-500 border-0 btn-circle">
            ❯
          </a>
        </div>
      </div>
