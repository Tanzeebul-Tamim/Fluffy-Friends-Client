      ...
      <div className="grid lg:gap-0 gap-3 grid-cols-1 lg:grid-cols-4">
        ...
        <div className="justify-self-center w-4/5 testimonial-card p-5 rounded-xl">
          <div className="mb-4 flex gap-4 items-center justify-between">
            ...
            <div>
              <h2 className="mb-3 text-xl font-bold">Sarah Thompson</h2>
        ...
        <div className="justify-self-center w-4/5 testimonial-card p-5 rounded-xl">
          <div className="mb-4 flex gap-4 items-center justify-between">
            ...
            <div>
              <h2 className="mb-3 text-xl font-bold">Emily Johnson</h2>
              <div className="text-3xl gap-3 text-amber-400 flex justify-end">
                <span>4.3</span>
                <FaStar></FaStar>
              </div>
        ...
        <div className="justify-self-center w-4/5 testimonial-card p-5 rounded-xl">
          <div className="mb-4 flex gap-4 items-center justify-between">
            ...
            <div>
              <h2 className="mb-3 text-xl font-bold">Mark Thompson</h2>
              <div className="text-3xl gap-3 text-amber-400 flex justify-end">
                <span>4.9</span>
                <FaStar></FaStar>
              </div>
